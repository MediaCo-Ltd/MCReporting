...
Dim OkStatus 
Dim ReturnAddress
ReturnAddress = Request.QueryString("sd")
Dim Digital
Dim Titletext
OkStatus = 0
Dim EditId
...
<table style="width: 100%;padding-right: 10px; padding-left: 10px;" >
    ...
    <tr>
        ...
        <td align="right" width="33%">
            ...
            &nbsp;<input id="ReturnAddress" value="<%=ReturnAddress%>" type="<%=Session("ShowHidden")%>" <%=Session("ShowHiddenSize")%>/>
...
While Not GetDatesRS.Eof 
    ...
    Call OpenMyLogsRs (GetDatesRS("CreatedSerial"))

...
<head>
    ...
    <title>OH Redo : Data Error</title>
...
<table style="width: 96%; position: absolute; top: 0px; " >
    ...
    <tr>
	    <td height="8" valign="top">
	        ...
	        <p><a href ="javascript:GoBack();" style="font-size:12px; color: <%=NewBlue%>;" >Return to main page</a><br /></p>      
...
<table style="width: 96%; position: absolute; top: 45%; " >  
    <tr>
        <td>
            <h3 align="center" style="color: #FF0000">System Error. Data for job can not be found</h3>
        </td>
    </tr>    
</table>

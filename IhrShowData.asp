...
If ReturnPage = "0" Then
    ReturnPage = "IhrDisplay.asp"
ElseIf ReturnPage = "5" Then
    ReturnPage = "IhrDisplayById.asp?sd=" & Request.QueryString("rp")    
ElseIf ReturnPage = "4" Then 
    ReturnPage = "IhrDisplayMulti.asp?Qid=" & DetailJob & "&qr=" & hQuoteRef 
Else
...
<table style="padding-right: 10px; padding-left: 10px; width: 100%;">
    <tr>
        <td align="left" width="20%" style="height: 20px">
            &nbsp;&nbsp;<a href ="javascript:window.location.replace('<%=ReturnPage%>');" style="font-size:12px; color: <%=NewBlue%>;">Return to view Page</a><br /><br />
        </td>
        <td align="center">
...
Function GetRedoCreator()
    ...
    GetRedoCreatorSql = "Select ID, Active, CreatedBy From OhQuoteData Where (ID = " & RedoId & ")"

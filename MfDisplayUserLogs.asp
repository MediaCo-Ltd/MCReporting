    ...
    <tr>
     ...
     <tr>     
        <td align="left" valign="middle" colspan="3">        
            <%
            If Session("UserEditOwnMf") = Cbool(True) Then
...
Call OpenMachine(RepairStatus, Session("UserId"))    

While Not MachineRs.Eof

    Msg = "<h4 style = 'color: Black' >&nbsp;&nbsp;" & MachineRs("MachineName") & " </h4>"    
    Call OpenLogs (MachineRs("Id"),RepairStatus, Session("UserId"))    
    ...
    <table  align="center" cellpadding="0" cellspacing="0"  width="95%">    
	   <tr >
        ...
        %>        
        <tr>
            <!--<td title="" style="color: #0069AA" class="styleTDleft" ><%'=LogRs("Id")%></td>-->
            
            <td title="" id="<%=EditId%>" style="color: #0069AA" class="styleTDleft"
                <%If Session("UserEditOwnMf") = Cbool(True) Then Response.Write " onclick='javascript:MFLoadEditOrder(" & EditId & ");'" %> ><%=LogRs("Id")%></td>
	        <!--<td  class="styleTDstd"><%'=CDate(LogRs("LogDateSerial"))%></td>-->
	        <td  class="styleTDstd"><%=LogRs("LogDate")%></td>	    
	        <%
	        ...
	        <td  class="styleTDstd"><%=LogRs("RepairDate")%></td>

...
LogSql = LogSql & " Logs.Severity, Logs.SelectedDate, Logs.SelectedDateSerial, Logs.Resolved,"
LogSql = LogSql & " Users.UserName, Reasons.Description"
LogSql = LogSql & " From Logs INNER JOIN Users ON Logs.UserId = Users.Id"
...
Emsg.FromName = "NC Reporting"
Emsg.Subject = "NC Reporting New " & EmailGroup & " Record #" & RecordToEmail

If Session("Smtp") = "mx496502.smtp-engine.com" Then 	    
    '## For testing at home
    ContentId1 = Emsg.AddAttachment(Session("RootPath") & "\Images\warning.png",true,"image/png")
...
If Session("Smtp") = "mx496502.smtp-engine.com" Then    
    ...
    ElseIf Session("PC-Name") = "Server" Then
        ...
        Else
            ...
            NotifyRs.Source = "SELECT EmailName, EmailAddress, EmailActive FROM Email Where (EmailActive = 1) AND (EmailNC = 1) Order By EmailName"
...
Sub UpdateEmailStatus
    ...
    EmailRs.ActiveConnection = Session("ConnNCReports")
...
MsgHtml = MsgHtml & "<title>NC Report</title>" & VbCrLf
...
MsgHtml = MsgHtml & "<img align='left' alt='NC logo' width='30px' src=""cid:" & ContentId1 & """ /> " & VbCrLf  ' width ='90px'
MsgHtml = MsgHtml & "</td>" & VbCrLf
MsgHtml = MsgHtml & "<td class='HeaderText' align='center'>NC Reporting New " & EmailGroup & " Record #" & RecordToEmail & "</td>" & VbCrLf
...
MsgHtml = MsgHtml & "<td  class='StdText' align='left'>" & LogRs("UserName") & "</td>" & VbCrLf

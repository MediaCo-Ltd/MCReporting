...
<table style="padding-right: 10px; padding-left: 10px; width: 100%;" >
    ...
    <tr>
        ...
        <td align="center" width="34%">
            ...
            <font style="color: #0069AA; font-weight: bold; font-size: 16px;">View&nbsp;Log&nbsp#<%=LogToGet%></font>
        </td>
...
<table  style="padding-right: 10px; padding-left: 10px;" align="center" cellpadding="0" cellspacing="0"  width="95%">        
    ...
    <tr>
        ...
        <td colspan="2">            
            ...
            <textarea   rows="20" id="txtResponse" <%=LockResponseText%>
...
<table style="padding-right: 10px; padding-left: 10px;" align="center" cellpadding="0" cellspacing="0"  width="95%">
    <tr>        
        <td>
            ...
            &nbsp;&nbsp;<input type="<%=TextType%>" id="frmName" name="frmName" value="frmViewLogNJ" />

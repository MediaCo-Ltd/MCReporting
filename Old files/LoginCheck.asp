...
Const consForReading = 1, consForWriting = 2, consForAppending = 8 
...
If strUserID <> "" Then		
    ...
    UserRs.Source = UserRs.Source & " FROM Users WHERE Id=" & strUserID & " AND PassWord='" & Replace(Request.Form("txtUserPW"),"'","''") & "'"

...
UsersRs.Source = "SELECT Id, UserName, AdminUser, HsEdit, NcEdit, MfEdit FROM Users Where(Id = " & LocalUserId & ")"
...
<table class="NonDataTables" style="width: 100%; position: absolute; top: 30%;" id="data">
    ...
    <tr>
        <td colspan="2" class="Userlabel" ><font size="3" style="color: #0069AA">&nbsp;&nbsp;<%=LocalUserName%></font></td>
    </tr>
    <tr>
        <td height="10px" >&nbsp;</td>
    ...
    <tr >
        ...
        <td valign="middle" >
            <input name="txtPassword" type= "text" id="txtPassword" class="inputboxes" value="" onfocus="javascript:PwClick('LoginPw');"
                onkeydown="return DisableEnterKey(event,'LoginPw');" onkeyup="javascript:EnableSubmit('LoginPw');"  onclick="javascript:PwClick('LoginPw');" style="color: #000000" />
    ...
    <td colspan="2" class="Pwlabel" >
            ...
            <%
                If NoReset = Cbool(False) Then
                    Response.Write "<br />If you have forgot your password click <a href ='javascript:ResetUser(" & LocalUserId & ");' style='color: #FF0000;'> here</a> then enter a new one, via the new user option on the logon page." & VbCrLf
                    Response.Write "<br /><label style='color: #FF0000;'>Before reseting ensure you have picked the correct name in the logon page</label>"
                End If
            %>
        </td>    
    </tr>

...
'############################## Add New User ##############################
    ...
    '############################## Create client 
        ...
        AddRs("PwEmail") = Cstr(Request.Form("txtEmail"))
        
        If Cstr(Request.Form("txtPassword")) = "0" Then
            '## New user set so shows in list
            '## Also used to set if user must have password
            AddRs("Active") = 1
            AddRs("ShowInList") = 1
            AddRs("PwRequired") = 1
            AddRs("Password") = ""
        ...
        Else
            ...
            If Request.Form("ChkHsView") = "on" Then  
                AddRs("HsView") = 1
            Else
                AddRs("HsView") = 0
            End If
            ...
            If Request.Form("ChkEditOwnMf") = "on" Then
                AddRs("UserEditOwnMf") = 1
            Else
                AddRs("UserEditOwnMf") = 0
            End If
        ...
        If Request.Form("chkRedo") = "on" Then  
            AddRs("RedoAdd") = 1
        Else
            AddRs("RedoAdd") = 0
        End If        
        
        If Request.Form("ChkRedoView") = "on" Then  
            AddRs("RedoView") = 1
            If Request.Form("ChkRedoCost") = "on" Then  
                AddRs("ShowRedoCost") = 1
            Else
                AddRs("ShowRedoCost") = 0
            End If
        Else
            AddRs("RedoView") = 0
            AddRs("ShowRedoCost") = 0
...
'############################## Edit User Update ##############################
    ...
    ElseIf Request.Form("frmName") = "frmEditUser" Then
        ...
        UpdateRs("PwEmail") = Cstr(Request.Form("txtEmail"))      
        ...
        If Request.Form("hDelete") = "1" Then        
            ...
            UpdateRs("RedoAdd") = 0 
            UpdateRs("RedoView") = 0 
            UpdateRs("ShowRedoCost") = 0
            UpdateRs("UserEditOwnMf") = 0
            RedirectUrl = "UsersDormant.asp"   
        Else      
            If Cstr(Request.Form("txtPassword")) = "0" Then
                UpdateRs("Active") = 1
                UpdateRs("ShowInList") = 1
                UpdateRs("PwRequired") = 1
                UpdateRs("Password") = ""
            Else
...
'############################## Add Email User Update ##############################
    ...
    ElseIf Request.Form("frmName") = "frmAddEmailUser" Then
        ...
        If Request.Form("chkMFC") = "on" Then  
            AddRs("InMFCGroup") = 1
        Else
            AddRs("InMFCGroup") = 0
        End If    
...
'############################## Edit Email User Update ##############################
    ...
    ElseIf Request.Form("frmName") = "frmEditEmailUser" Then
        ...
        If Request.Form("chkMFC") = "on" Then  
            UpdateRs("InMFCGroup") = 1
        Else
            UpdateRs("InMFCGroup") = 0
        End If 
